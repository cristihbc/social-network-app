 ...
 *  Description: Class that holds the test methods for the photo          *
 *               service.                                                 *
 *                                                                        *
...
namespace UnitTests
{
    ...
    public class PhotoServiceUnitTest
    {
        ...
        /// </summary>
        private PhotoService commentService = new PhotoService();

        /// <summary>
        /// Temporary comment pool with premade instances
        /// </summary>
        private List<PhotoEntity> PhotoPool = new List<PhotoEntity>()
        {
            new PhotoEntity()
            {
                Id = 1,
        ...
        /// </summary>
        [TestMethod]
        public void PhotoListShouldBeZero()
        {
            // Arrange
            int commentsLength;
